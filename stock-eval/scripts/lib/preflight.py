...
structured REFUSE message. The caller (scripts/stock_eval.py main()) writes
...
def _refuse_message(topic: str) -> str:
    return (
        f'[stock-eval] REFUSE: topic "{topic}" matches Class 1 keyword-trap '
        ...
        "re-invoke with STOCK_EVAL_SKIP_PREFLIGHT=1 to bypass this gate.\n"
    )

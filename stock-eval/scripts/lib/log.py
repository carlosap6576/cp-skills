"""Shared logging utilities for stock-eval skill."""

import os
import sys

DEBUG = os.environ.get("STOCK_EVAL_DEBUG", "").lower() in ("1", "true", "yes")


def debug(msg: str) -> None:
    """Log debug message to stderr (only when STOCK_EVAL_DEBUG is set)."""
    if DEBUG:

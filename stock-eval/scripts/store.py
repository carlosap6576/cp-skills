#!/usr/bin/env python3
"""SQLite research accumulator for stock-eval.
...
Database location: ~/.local/share/stock-eval/research.db
"""
...
DB_DIR = Path.home() / ".local" / "share" / "stock-eval"
...
def main():
    parser = argparse.ArgumentParser(description="Query the stock-eval research database")
